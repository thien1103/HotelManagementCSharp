...
namespace HotelManager
{
    public partial class fProfile : Form
    {
        ...
        {
            //if (AccountDAO.Instance.HashPassword(txbPass.Text) == Password && txbNewPass.Text != String.Empty && txbReNewPass.Text != String.Empty)
            string hashedPassword = AccountDAO.Instance.GetHashedPassword(txbPass.Text);
            if (hashedPassword == Password && txbNewPass.Text != String.Empty && txbReNewPass.Text != String.Empty)
            {
