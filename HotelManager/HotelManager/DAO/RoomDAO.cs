...
namespace HotelManager.DAO
{
    public class RoomDAO
    {
        ...
        {
            return DataProvider.Instance.ExecuteQuery("SELECT * FROM VW_LoadFullRoom");
        }
        ...
        internal bool UpdateCustomer(Room roomNow)
        {
            ...
            return DataProvider.Instance.ExecuteNoneQuery(query, new object[] { roomNow.Id, roomNow.Name, roomNow.IdRoomType, 
                roomNow.IdStatusRoom }) > 0;
        }
        ...
        {
            /*string query = "USP_LoadListFullRoom";*/
            string query = "SELECT * FROM VW_LoadListFullRoom ORDER BY ID ASC";
            List<Room> rooms = new List<Room>();
